aws lambda create-function \
  ...
  --zip-file fileb://login/demo/build/libs/login-0.1.jar \
  --timeout 30 \
...
aws lambda create-function \
  ...
  --role arn:aws:iam::000000000000:role/lambda-role \
  --zip-file fileb://analyticsDashboard/demo/build/libs/analyticsDashboard-0.1.jar \
  --timeout 30 \
  --environment Variables={DYNAMODB_ENDPOINT=http://172.17.0.2:4566}
...
aws lambda create-function \
  ...
  --role arn:aws:iam::000000000000:role/lambda-role \
  --zip-file fileb://transactions/demo/build/libs/transactions-0.1.jar \
  --timeout 30 \
  --environment Variables={DYNAMODB_ENDPOINT=http://172.17.0.2:4566}
